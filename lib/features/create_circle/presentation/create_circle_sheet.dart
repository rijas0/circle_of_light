        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text('Set up your Quran study circle',
              ...
              Wrap(
                ...
                children: _focuses.map((f) => _chip(f, _focus == f, () => setState(() => _focus = f))).toList(),
              ),
              const SizedBox(height: 20),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: selected ? const Color(0xFF2ECC71).withOpacity(0.6) : Colors.white.withOpacity(0.1),
          ),
        ),
        child: Text(label,
            style: TextStyle(
              color: selected ? const Color(0xFF2ECC71) : Colors.white.withOpacity(0.5),
              fontSize: 13,
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(12),
            border: Border.all(
              color: selected ? const Color(0xFF2ECC71).withOpacity(0.5) : Colors.white.withOpacity(0.08),
            ),
          ),
          child: Row(
            ...
            children: [
              Icon(icon,
                  color: selected ? const Color(0xFF2ECC71) : Colors.white.withOpacity(0.35),
                  size: 16),
